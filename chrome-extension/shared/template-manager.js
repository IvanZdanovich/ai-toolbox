    ...
    const defaultTemplates = [
      {
        ...
        prompt:
          'Write a professional email response to the following message: {email_content}. The tone should be {tone} and include {key_points}.',
        inputs: [
          {
            name: 'email_content',
      ...
      },
      {
        ...
        prompt:
          'Create comprehensive documentation for this {language} code: {code}. Include purpose, parameters, return values, and usage examples.',
        inputs: [
          {
            name: 'language',
      ...
      },
      {
        ...
        prompt:
          'Summarize the following meeting notes into key points, action items, and decisions made: {meeting_notes}. Format as: Key Points, Action Items (with owners), and Decisions.',
        inputs: [
          {
            name: 'meeting_notes',
            label: 'Meeting Notes',
