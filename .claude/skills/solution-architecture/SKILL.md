...
ADR_ID: give every entry a hierarchical id `<scope>.adr-<n>[.<n>...]` — a child id extends its parent's (`checkout.adr-1` → `checkout.adr-1.1` → `checkout.adr-1.1.2`) to record a decision made *within* the scope of an earlier one; ids are assigned once and never renumbered or reused
