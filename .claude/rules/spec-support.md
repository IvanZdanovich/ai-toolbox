...
SUPPORT_NAME_CHECK: every file is named for its subject and ends in `.mock.js` or `.setup.js`; no role-named file or directory exists, and no `.test.js`/`.spec.js` sits here.
